  ...
  return (
    <section className="py-20 bg-dark-200">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl font-bold mb-12 text-center text-white">Resume</h2>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-6 animate-fade-up">
            <h3 className="text-2xl font-semibold mb-6 text-purple-300">Experience</h3>
          ...
          <div className="space-y-6 animate-fade-up" style={{ animationDelay: "200ms" }}>
            <h3 className="text-2xl font-semibold mb-6 text-purple-300">Education</h3>
            {education.map((edu, index) => (
              <Card key={index} className="bg-dark-100 border-none">
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-2">
                    <h4 className="text-xl font-medium text-white">{edu.degree}</h4>
                    <span className="text-sm text-purple-300">{edu.period}</span>
                  </div>
                  <p className="text-purple-200 mb-2">{edu.school}</p>
